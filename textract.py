...
class amazon_textract:
    def __init__(self,accesskey,secretaccesskey,region):          
        self.textractclient=boto3.client("textract",aws_access_key_id=accesskey,aws_secret_access_key=secretaccesskey,region_name=region)      
